...
import DocumentViewer from "@/components/ui/DocumentViewer"; // Ganti nama import PDFViewer jadi DocumentViewer
...
// Ubah parameter agar langsung menerima id string dari Server Component
export default function JurnalDetailClient({ id }: { id: string }) {
