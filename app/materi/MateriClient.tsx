...
function MateriContent() {
  ...
  const [isLoading, setIsLoading] = useState(!globalMateriCache); 
  ...
  useEffect(() => {
    ...
    setCurrentPage(1);
  }, [selectedYear, selectedSemester, activeFilter, filterTabs]); 
  ...
  return (
    <div className="min-h-screen pt-20 md:pt-28 pb-12 md:pb-20 animate-in fade-in duration-700 px-4 md:px-8 relative">
      ...
      {/* Tampilan halaman (sisanya tetap sama) */}
